...
class Editorial():
    ...
    def __init__(self,DETAILS):
        ...
        def Provide():
            ...
            window.destroy()
            ShowDetails.Show((self.IDdb,self.NAMEdb,self.AGEdb,self.GENDERdb,self.POSTdb,self.CONTACTdb,self.ADDRESSdb,DETAILS[-1]))
        ...
        Spinbox1 = tk.Spinbox(window, from_=18.0, to=50.0,background="white",
                                                        buttonbackground="#d9d9d9",value = int(DETAILS[2]))
        ...
        elif DETAILS[3] == 'Female':

            Radiobutton1_4.select()
        ...
        ContactEntry.insert(0,DETAILS[5])
        ############################################################
        ...
        Button1.configure(text='''Save Edits''')
