...
#                self.IdLab.place(relx=0.21, rely=0.229, height=41, width=54)
                ...
                self.IdLab.configure(font="-family {Product Sans} -size 18 -weight normal")
...
#                self.NAMLab.place(relx=0.19, rely=0.28, height=41, width=54)
                ...
                self.NAMLab.configure(font="-family {Product Sans} -size 18 -weight normal")
...
#                self.DEPLab.place(relx=0.12, rely=0.328, height=41, width=94)
                ...
                self.DEPLab.configure(font="-family {Product Sans} -size 18 -weight normal")
...
#                self.IdData.place(relx=0.317, rely=0.242, height=21, width=224)
                ...
                self.IdData.configure(font="-family {Product Sans} -size 18 -weight bold")
...
#                self.NMEData.place(relx=0.317, rely=0.292, height=21, width=224)
                ...
                self.NMEData.configure(font="-family {Product Sans} -size 18 -weight bold")
...
#                self.DEPData.place(relx=0.317, rely=0.339, height=21, width=224)
                ...
                self.DEPData.configure(font="-family {Product Sans} -size 18 -weight bold")
...
ListKAKA([(1,'Aayush',12,'Male','Cashier','1','Bhuj',1,1),
