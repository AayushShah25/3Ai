...
class MAINCALL():
    ...
    def __init__(self,Admin_id):
        ...
        train.place(relx=0.375, rely=0.200, height=100, width=150)
        ...
        Improve.place(relx=0.375, rely=0.450, height=100, width=150)
        ...
        Btn4 = tk.Button(window,text='Generate Report',
                                        font="-family {Product Sans} -size 14 -weight bold", command = GenerateReport)
        ...
        specific = tk.Button(window, text = "Attendance", font="-family {Product Sans} -size 14 -weight bold", command=checkAttendance, bg = "#800040", fg="#FFFFFF", wraplength = "150")
        specific.place(relx=0.375, rely=0.750, height=100, width=150)
